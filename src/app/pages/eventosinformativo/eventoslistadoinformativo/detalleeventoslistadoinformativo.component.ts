...
import { EventosInformativo } from 'src/app/models/eventosinformativo';


@Component({
  selector: 'app-detalleeventoslistadoinformativo',
  templateUrl: './detalleeventoslistadoinformativo.component.html'
})
export class DetalleeventoslistadoInformativoComponent implements OnInit {
  ...
  rowdetalle: EventosInformativo = new EventosInformativo();
  ...
  listaeventos() {
    ...
    this.eventosService.getListadoRelacionadosInformativo(tokenid).subscribe((respuesta: any) => {
  ...
  saveEventosRelacionados() {
    ...
    this.eventosService.guardarEventosRelacionadosInformativo(valor).subscribe(respuesta => {
      Swal.fire({
  ...
  detalleEvento() {
    ...
    this.eventosService.getDetalleEvento(tokenid)
      .subscribe((respuesta: EventosInformativo) => {
  ...
  guardaModificacionInformativo() {
    const valor = JSON.stringify(this.Modificacion.value);

    this.eventosService.guardarModificacionInformativo(valor).subscribe(respuesta => {
      Swal.fire({
